...
This Machine Learning Model is built to predict resale price for cars and bikes.
You can select the vehicle from the sidebar, fill the details and get the predicted Price.""")
